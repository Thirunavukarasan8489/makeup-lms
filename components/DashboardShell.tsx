...
function DashboardIcon({ name }: { name: DashboardIconName }) {
  ...
  switch (name) {
    ...
    case "staff":
      return (
        <svg className={className} viewBox="0 0 24 24" aria-hidden>
          <path strokeLinecap="round" strokeLinejoin="round" d="M16 20V6a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v14" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M6 20h12M12 10v4M10 12h4" />
        </svg>
      );
    case "courses":
      return (
    ...
    case "certificate":
      return (
        <svg className={className} viewBox="0 0 24 24" aria-hidden>
          <path strokeLinecap="round" strokeLinejoin="round" d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7l-5-5Z" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M14 2v6h6M9 15l2 2 4-5" />
        </svg>
      );
    case "enquiry":
      return (
    ...
    default:
      return (
        <svg className={className} viewBox="0 0 24 24" aria-hidden>
          <path strokeLinecap="round" strokeLinejoin="round" d="M3 13h8V3H3v10ZM13 21h8V11h-8v10ZM13 9h8V3h-8v6ZM3 21h8v-6H3v6Z" />
        </svg>
      );
  }
}
